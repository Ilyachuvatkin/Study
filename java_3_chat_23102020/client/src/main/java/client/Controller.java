        ...
        try {
            ...
            new Thread(() -> {
                try {
                    ...
                    viewOldHistory(history.getOldHistory(100));
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            ...
                            if (str.startsWith("/chgOk")) {
                                ...
                                history.changeNameFileLog(token[1]);
                                System.out.println();
                            }
...
//                                outFile.write(str+"\n");
    ...
    private void viewOldHistory(ArrayList<String> oldHistory) {
